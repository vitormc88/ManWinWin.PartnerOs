...
import { mockOnboarding, onboardingStages } from "@/data/partner-engagement-data";
...
/**
 * The original Onboarding lifecycle view, preserved unchanged as a secondary
 * tab of the Partner Academy.
 */
